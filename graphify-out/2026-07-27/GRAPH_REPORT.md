...
## Corpus Check
- 34 files · ~18,552 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 235 nodes · 240 edges · 27 communities (16 shown, 11 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9c579f67`
...
## Knowledge Gaps
- **154 isolated node(s):** `github.com/rlevidev/curriculo.ai`, `fs`, `css`, `$schema`, `plugins` (+149 more)
