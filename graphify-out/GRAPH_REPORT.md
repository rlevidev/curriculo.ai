# Graph Report - curriculo.ai  (2026-07-27)

## Corpus Check
- 29 files · ~17,542 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 221 nodes · 233 edges · 21 communities (15 shown, 6 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5bb10abb`
...
### Community 3 - "main.go"
Cohesion: 0.14
Nodes (23): Education, Experience, Language, corsMiddleware(), generatePdfHandler(), main(), rateLimiter(), TestGeneratePdfHandler_MissingFields() (+15 more)
...
Cohesion: 0.08
Nodes (22): Further Notes, Out of Scope, Prior Art, Problem Statement, Seam 1 — API Contract (Integration), Seam 2 — Resume State → Preview (Unit, Frontend), Seam 3 — Go Handler → LaTeX Renderer (Unit, Backend), Seam 4 — LaTeX → pdflatex (Integration, Backend) (+14 more)
...
## Knowledge Gaps
- **144 isolated node(s):** `github.com/rlevidev/curriculo.ai`, `$schema`, `plugins`, `react/rules-of-hooks`, `react/only-export-components` (+139 more)
...
- **Why does `Spec: curriculo.ai MVP` connect `Tickets: curriculo.ai MVP` to `Implementation Decisions`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `Implementation Decisions` connect `Implementation Decisions` to `Tickets: curriculo.ai MVP`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **What connects `github.com/rlevidev/curriculo.ai`, `$schema`, `plugins` to the rest of the system?**
